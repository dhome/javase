...
public class Chapter1 {
	 ...
	 * 
	 * Access Control<ul>
	 * <li>The reference <code>this</code> alwasy refers to the current executing object</li>
	 * <li><code>protected</code> - for a subclass outside the package, the <code>protected</code> member can be accessed only through inheritance. <code>default</code> members can only accessed by classes in the same package</li>
	 * </ul>
	 * 
	 * Declaration<ul>
	 ...
	 *
	 * Constructor<ul>
	 * <li>Cannot be marked as <code>final</code> or <code>abstract</code> or <code>static</code></li>
	 * </ul>
	 * 
	 * Enum Declaration<ul>
	 ...
	 * </ul>
	 *
	 * Legal Identifier starts with<ul>
	 * <li>letter</li>
