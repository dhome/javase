 ...
 * Override
 * <ul>
 * <li>Compiler looks only at the referenceType, not instance types. The method
 * in the reference type will be executed</li>
 * <li>Access level can be less restrective</li>
 * <li>The override method can throw any unchecked (runtime) exception,
 * regardless of whether the overridden method declares the exception, but
 * cannot thrwo checkt exception</li>
 ...
 * <li>the first line in a constructor must be a call to <code>super()</code) or
 * a call to <code>this()</code></li>
 * </ul>
 * 
 * Else
 * <ul>
