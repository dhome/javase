 ...
 * Literals
 * <ul>
 * <li>octal: placeing a zero in front of the number (f.e.
 * <code>06 || 011</code>, 6dez || 9dec)</li>
 ...
 * <li>you cannot widen and then box (f.e. <code>int</code> -> <code>Long</code>
 * )</li>
 * <li>you can box and then widen (<code>int</code> -> <code>Integer</code> ->
 * <code>Object</code>)</li>
